...
- **Play with the person at the next desk** over the local network: Air Hockey (best of 3), Pong,
  H-O-R-S-E, Mini Golf, Archery and Cannon Castles duels, board games, Sea Battle and score races in twenty-one games. You see
...
| Flag | Purpose |
|---|---|
| `--game <id>` | Start on a specific game: `hoops`, `archery`, `juggle`, `golf`, `bugs`, `cans`, `bricks`, `bubbles`, `hockey`, `pong`, `clay`, `whack`, `plinko`, `tower`, `slingshot`, `checkers`, `chess`, `connect4`, `tictactoe`, `seabattle`, `durak`, `darts`, `toss`, `fishing`, `bowling`, `pool`, `pinball`, `memory`, `codebreaker`, `solitaire`, `lastcard`, `interns`, `blockfall`, `cannons`, `pet` |

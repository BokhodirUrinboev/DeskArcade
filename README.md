...
- **35 games, 92 achievements**, a daily challenge, play-time stats, and English, Uzbek and Russian text.
...
played and best score per game, and all 92 achievements with their progress. Stats live in
...
| Flag | Purpose |
|---|---|
| `--game <id>` | Start on a specific game: `hoops`, `archery`, `juggle`, `golf`, `bugs`, `cans`, `bricks`, `bubbles`, `hockey`, `pong`, `clay`, `whack`, `plinko`, `tower`, `slingshot`, `checkers`, `chess`, `connect4`, `tictactoe`, `seabattle`, `durak`, `darts`, `toss`, `fishing`, `bowling`, `pool`, `pinball`, `memory`, `codebreaker`, `solitaire`, `lastcard`, `interns`, `blockfall`, `marble`, `pet` |

...
(and the pet's favourite nap spot), and all 104 achievements with their progress. Stats live in
...
| Tray icon menu | Game, pet, CPU difficulty (every game with a computer opponent, and the race toggle), theme, break reminder, office leaderboard, volume, pet volume, language, Claude Code options, updates, stats, monitor, reset, exit |

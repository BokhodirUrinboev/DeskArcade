...
- **39 games, 104 achievements**, a daily challenge, play-time stats, and English, Uzbek and Russian text.
...
played and best score per game, and all 104 achievements with their progress. Stats live in
...
| Tray icon menu | Game, pet, CPU difficulty (every game with a computer opponent, and the race toggle), theme, break reminder, office leaderboard, play over LAN (emotes and gifts for a co-worker's pet too), volume, language, Claude Code options, updates, stats, monitor, reset, exit |
